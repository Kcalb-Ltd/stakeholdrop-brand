# Stake Only brand assets

<p>
<img src="assets/png/square/stakeholdrop-square-200.png" width="96" alt="Stake Only app icon">&nbsp;
<img src="assets/png/round/stakeholdrop-round-200.png" width="96" alt="Stake Only round avatar">&nbsp;
<img src="assets/png/symbol-color/stakeholdrop-symbol-color-200.png" width="96" alt="Stake Only symbol">
</p>

Official logo files for **Stake Only** — *Earn · Hold · Drop* — [stakeholdrop.com](https://stakeholdrop.com).
Stake Only is a brand of [Kcalb Ltd](https://kcalb-ltd.com), part of the KcalbApp ecosystem.
...
Direct links, for integrations: `https://raw.githubusercontent.com/Kcalb-Ltd/stakeholdrop-brand/main/assets/png/round/stakeholdrop-round-500.png`. For production, pin a commit hash instead of `main` and check the file against [asset-manifest.json](asset-manifest.json).

## Official colors

| Color | Hex | Use |
|---|---|---|
| Stake Only | `#7C3AED` | background of the icon, symbol on light backgrounds |
| Shadow | `#341864` | drop shadow under the symbol only |
...
- Refer to the brand as **Stake Only**, with this exact spelling.
...
Copyright © 2026 Kcalb Ltd. All rights reserved — the [LICENSE](LICENSE) allows use of the unmodified files to refer to Stake Only.
Questions and requests: **contact@stakeholdrop.com**, or open an [issue](https://github.com/Kcalb-Ltd/stakeholdrop-brand/issues).
